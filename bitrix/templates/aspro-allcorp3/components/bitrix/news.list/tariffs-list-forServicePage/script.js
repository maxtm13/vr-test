...
$(document).ready(function () {
    ...
    const cards = document.getElementsByClassName("tariffs-list__item-text-wrapper");
    let buttons;

    for (j = 0; j < cards.length; j += 1) {

        buttons = cards[j].getElementsByClassName("tariffs-list__tabs__item");

        content = cards[j].getElementsByClassName("tariffs-list__tabs-content__item");
        if (buttons.length) {
