...
$cntVisibleChars = $cntVisibleChars >= 0 ? $cntVisibleChars : 1;
...
<?endif;?>
		...
		<?if($navPageNomer < 2):?>
			<?if($bSlider):?>
				<div class="owl-carousel maxtm1 <?=$owlClasses?>" data-plugin-options='{"nav": true, "rewind": true, "dots": true, "dotsContainer": false, "loop": true, "autoplay": false, "marginMove": true, "margin": 10<?//=($arParams['ITEMS_OFFSET'] ? ($arParams['GRID_GAP'] ? $arParams['GRID_GAP'] : "32") : ($arParams['BORDER'] ? "-1" : "0"))?>, "responsive": {"0": {"autoWidth": true, "lightDrag": true, "dots": <?=$bDots0?>, "items": <?=$items0?> <?=($arParams['ITEMS_OFFSET'] ? ', "margin": 24' : '')?>}, "380": {"autoWidth": true, "lightDrag": true, "dots": <?=$bDots380?>, "items": <?=$items380?> <?=($arParams['ITEMS_OFFSET'] ? ', "margin": 24' : '')?>}, "768": {"autoWidth": false, "lightDrag": false, "dots": <?=$bDots768?>, "items": <?=$items768?>}, "1200": {"autoWidth": false, "lightDrag": false, "dots": <?=$bDots1200?>, "items": <?=$items1200?>} }}'>
<!--				<div class="owl-carousel  --><?php //=$owlClasses?><!--" data-plugin-options='{"nav": true, "rewind": true, "dots": true, "dotsContainer": false, "loop": false, "autoplay": false, "marginMove": true, "margin": --><?php //=($arParams['ITEMS_OFFSET'] ? ($arParams['GRID_GAP'] ? $arParams['GRID_GAP'] : "32") : ($arParams['BORDER'] ? "-1" : "0"))?><!--, "responsive": {"0": {"autoWidth": true, "lightDrag": true, "dots": --><?php //=$bDots0?><!--, "items": --><?php //=$items0?><!-- --><?php //=($arParams['ITEMS_OFFSET'] ? ', "margin": 24' : '')?><!--}, "380": {"autoWidth": true, "lightDrag": true, "dots": --><?php //=$bDots380?><!--, "items": --><?php //=$items380?><!-- --><?php //=($arParams['ITEMS_OFFSET'] ? ', "margin": 24' : '')?><!--}, "768": {"autoWidth": false, "lightDrag": false, "dots": --><?php //=$bDots768?><!--, "items": --><?php //=$items768?><!--}, "1200": {"autoWidth": false, "lightDrag": false, "dots": --><?php //=$bDots1200?><!--, "items": --><?php //=$items1200?><!--} }}'>-->
			<?else:?>
				<div class="<?=$gridClass?>">
			<?endif;?>
		<?endif;?>
				...
				<?foreach($arItems as $i => $arItem):?>
					...
					<div class="tariffs-list__wrapper <?=$itemWrapperClasses?>">
						<div class="tariffs-list__item js-popup-block rounded-20 <?=$itemClasses?> <?=($bDetailLink ? '' : 'tariffs-list__item--cursor-initial')?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
										...
										if(
											...
											<?foreach($arItem['MIDDLE_PROPS'] as $PCODE => $arProperty):?>
												<?foreach((array)$arProperty['DISPLAY_VALUE'] as $val):?>
													...
													<div class="tariffs-list__item-properties-item-wraper mmm<?echo($bCollapsed)?><?=($bCollapsed ? ' collapsed' : '')?>"<?=($bCollapsed ? ' style="display:none"' : '')?>>
