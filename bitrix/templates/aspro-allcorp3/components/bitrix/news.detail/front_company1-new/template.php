...
<div class="company-item <?=$templateName?>-template">
	...
	<div class="company-item__wrapper company-item--<?=$arParams['TYPE_BLOCK'];?>">
		...
		<?ob_start();?>
			<?if ($bShowBtn):?>
				<div class="index-block__btn button_add_whatsapp">
					
					<script data-b24-form="click/8/ts81am" data-skip-moving="true">(function(w,d,u){var s=d.createElement('script');s.async=false;s.src=u+'?'+(Date.now()/180000|0);var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);})(window,document,'https://cdn-ru.bitrix24.ru/b25905132/crm/form/loader_8.js');</script>

					<a  class="btn btn-transparent-border btn-lg">
						<?=$arResult['DISPLAY_PROPERTIES']['MORE_BUTTON_TITLE']['VALUE']?>
                        <!--					<a href="--><?php //=str_replace('//', '/', SITE_DIR.'/'.$arResult['DISPLAY_PROPERTIES']['URL']['VALUE'])?><!--" class="btn btn-transparent-border btn-lg">-->
