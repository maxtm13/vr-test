...
<script>
	...
	<?global $arTheme;?>
	<div class="form maxtm1">
		<pre> Паспорт
		<? print_r($arResult["arUser"]["SECOND_NAME"]);	?>
		</pre>
			...
			<form method="post" name="form1" class="main-form" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
				...
				<?endif;?>
					...
					<div class="form-group">
						<div class="wrap_md">
							<div class="iblock label_block">
								<label for="user__passport" class="font_13 color_666">Паспортные данные</label>
								<div class="input">
									<input type="text" name="user__passport" id="user__passport" maxlength="50" class="user__passport" value="<?=$arResult["arUser"]["SECOND_NAME"];?>" />
								</div>
							</div>
						</div>
					</div>
